	...
	return match(createUserResult, {
		...
		Err: [
			[
				...
				buildErrorResponse<EditUserViewErrors>(context)(400),
			],
			[
				UserErrors.UserNotFound,
				buildErrorResponse<EditUserViewErrors>(context)(404),
			],
			[
				UserErrors.UsernameAlreadyTaken,
				buildErrorResponse<EditUserViewErrors>(context)(409),
			],
			[
			...
			[
				CommonErrors.ServerError,
				buildErrorResponse<EditUserViewErrors>(context)(500),
			],
		],
		_: () =>
			buildErrorResponse<EditUserViewErrors>(context)(500)(
